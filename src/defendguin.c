...
#define MAX_JOY_BTNS 32
#define AXIS_THRESH 512


/* Previously (prior to 0.0.13), we preferred 16bpp, but also preferred native modes to emulated 16bpp. */
/* Now (since 0.0.13), using 32bpp as the default */
#define VIDEO_BPP 32
...
const char * image_names[NUM_IMAGES] = {
  ...
  DATA_PREFIX "images/ufo/ufo_lft00.bmp",
  DATA_PREFIX "images/ufo/ufo_lft01.bmp",
  DATA_PREFIX "images/ufo/ufo_lft02.bmp",
  DATA_PREFIX "images/ufo/ufo_lft03.bmp",
  DATA_PREFIX "images/ufo/ufo_lft04.bmp",
  DATA_PREFIX "images/ufo/ufo_lft05.bmp",
  DATA_PREFIX "images/ufo/ufo_lft06.bmp",
  DATA_PREFIX "images/ufo/ufo_lft07.bmp",
  DATA_PREFIX "images/ufo/ufo_lft08.bmp",
  DATA_PREFIX "images/ufo/ufo_lft09.bmp",
  DATA_PREFIX "images/ufo/ufo_lft10.bmp",
  DATA_PREFIX "images/ufo/ufo_lft11.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr00.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr01.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr02.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr03.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr04.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr05.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr06.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr07.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr08.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr09.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr10.bmp",
  DATA_PREFIX "images/ufo/ufo_ctr11.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt00.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt01.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt02.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt03.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt04.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt05.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt06.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt07.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt08.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt09.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt10.bmp",
  DATA_PREFIX "images/ufo/ufo_rgt11.bmp",
  ...
  DATA_PREFIX "images/boss/boss00.bmp",
  DATA_PREFIX "images/boss/boss01.bmp",
  DATA_PREFIX "images/boss/boss02.bmp",
  DATA_PREFIX "images/boss/boss03.bmp",
  DATA_PREFIX "images/boss/boss04.bmp",
  DATA_PREFIX "images/boss/boss05.bmp",
  DATA_PREFIX "images/boss/boss06.bmp",
  DATA_PREFIX "images/boss/boss07.bmp",
  DATA_PREFIX "images/boss/boss08.bmp",
  DATA_PREFIX "images/boss/boss09.bmp",
  DATA_PREFIX "images/boss/boss10.bmp",
  DATA_PREFIX "images/boss/boss11.bmp",
  DATA_PREFIX "images/boss/boss-hurt.bmp",
  DATA_PREFIX "images/boss/flame1.bmp",
  DATA_PREFIX "images/boss/flame2.bmp",
  DATA_PREFIX "images/boss/flame3.bmp",
...
#if (WIDTH == 800)
  DATA_PREFIX "images/status/status-area-800.bmp",
#else
  ...
  DATA_PREFIX "images/status/map-boss.bmp",
  DATA_PREFIX "images/status/map-ship.bmp",
  DATA_PREFIX "images/status/ships.bmp",
...
const char * sound_names[NUM_SOUNDS] = {
  ...
  DATA_PREFIX "sounds/boss/intro.wav",
  DATA_PREFIX "sounds/boss/success1.wav",
  DATA_PREFIX "sounds/boss/success2.wav",
  DATA_PREFIX "sounds/boss/success3.wav",
  DATA_PREFIX "sounds/boss/shoot.wav",
  DATA_PREFIX "sounds/boss/mine.wav",
  DATA_PREFIX "sounds/boss/hurt.wav",
  DATA_PREFIX "sounds/boss/low.wav",
  DATA_PREFIX "sounds/boss/die.wav",
  ...
  DATA_PREFIX "sounds/pause.wav",
  DATA_PREFIX "sounds/keyclick.ogg",
};


#define MUS_TITLE DATA_PREFIX "music/320089_1738784-lq.ogg"
#define MUS_CONFIG DATA_PREFIX "music/460432_6300624-lq.ogg"
...
const char * game_music_names[NUM_GAME_MUSICS] = {
  ...
  DATA_PREFIX "music/572378_1015240-lq.ogg"
};
...
#define CHANCE_BOSS_SHOOT 20
#define CHANCE_BOSS_MINE 100
...
int highscore, num_players, vol_effects, vol_music,
  joy_x, joy_y, joy_fire, joy_bomb, joy_thrust, joy_reverse,
  hat_no_x;
...
Mix_Music * title_music, * config_music;
Mix_Music * game_musics[NUM_GAME_MUSICS];
Mix_Music * last_music, * win_music;
...
int title(void);
void setup(void);
SDL_Surface * set_vid_mode(unsigned flags, int bpp);
...
void create_auroras(void);
void move_auroras(void);
void draw_auroras(void);
...
int game(int mode)
{
  ...
  SDLKey key;
  SDL_Rect dest, src;
  int i, j, done, quit, frame, zz, tmp_x, tmp_y, tmp_w, img, xsize, ysize,
  ...
  do
    {
      ...
      while (SDL_PollEvent(&event))
        {
          if (event.type == SDL_KEYDOWN)
              ...
              if (event.jaxis.axis == joy_x)
                {
                  ...
                  if (event.jaxis.value < -AXIS_THRESH &&
                      dying[player] == 0 &&
                      dancing[player] == 0)
                    {
                      /* Stick left: */
              ...
              else if (event.jaxis.axis == joy_y)
                {
                  ...
                  if (event.jaxis.value < -AXIS_THRESH)
                   ...
                   (num_joysticks < 2 || event.jhat.which == player))
            {
              /* Joystick hat (e.g., d-pad) motion: */
              /* (N.B. We don't bother testing _which_ hat was moved!) */
              ...
              if (event.jhat.value & SDL_HAT_LEFT && !hat_no_x)
                {
                  left_down = 1;
                  right_down = 0;
              ...
              else if (event.jhat.value & SDL_HAT_RIGHT && !hat_no_x)
                {
                  right_down = 1;
                  left_down = 0;
                   ...
                   (num_joysticks < 2 || event.jbutton.which == player))
            {
              ...
              else if (event.jbutton.button == joy_reverse &&
                       dying[player] == 0 &&
                       dancing[player] == 0)
                {
                  /* Reverse */
              ...
              else if (event.jbutton.button == joy_thrust &&
                       dying[player] == 0 &&
                       dancing[player] == 0)
                {
                  /* Thrust */
                  ...
                  thrust_down = 1;
                   ...
                   (num_joysticks < 2 || event.jbutton.which == player))
            {
              if (event.jbutton.button == joy_thrust)
                thrust_down = 0;
            }
      ...
      if (level_time[player] == 2)
        {
          ...
          if (level[player] != 20)
            ...
            {
              /* Last level! */
              add_alien(x[player] + (dir[player] == DIR_LEFT ? -256 : 256), -1, ALIEN_BOSS, ALIEN_MODE_BEAM_IN, 128);
              playsound(SND_BOSS_INTRO, 3, 1);
            }
              ...
              if (num_players == 2)
                {
                  ...
                  if (lives[player] < 0 || dancing[player] == 1000)
                    player = 1 - player;
                }
              
              if (lives[player] >= 0)
                {
		  /* FIXME: Should be modularized */
                  dying[player] = 0;
      ...
      if (dancing[player] > 0)
              ...
              if (num_players == 1)
		{
	      ...
	      else if (dancing[1 - player] < 1000 && lives[1 - player] > 0)
	        {
                  player = 1 - player;
          ...
          if (lasers[i].alive)
            {
              ...
              if (lasers[i].x2 == WIDTH)
                {
                  lasers[i].x1 = lasers[i].x1 + LASER_SPEED;
                  if (lasers[i].x1 >= WIDTH)
                    lasers[i].alive = 0;
                }
          ...
          if (bullets[i].alive)
            {
              ...
              if (bullets[i].y < 80 || bullets[i].y >= HEIGHT ||
                  bullets[i].timer <= 0)
                bullets[i].alive = 0;
          ...
          if (explosion_bits[i].alive)
            {
              ...
              if (explosion_bits[i].y < 80 || explosion_bits[i].y >= HEIGHT)
                explosion_bits[i].alive = 0;
      ...
      for (i = 0; i < MAX_PENGUINOIDS; i++)
        {
          if (penguinoids[player][i].alive)
            {
              if (penguinoids[player][i].mode == PENG_MODE_FALLING)
                {
                  /* Move vertically: */
              ...
              else if (penguinoids[player][i].mode == PENG_MODE_SAVED)
                {
                  ...
                  tmp_x = penguinoids[player][i].x / 32;
                  if (tmp_x >= 0 && tmp_x < LAND_WIDTH)
                    { 
                      if (land[player][tmp_x][penguinoids[player][i].y / 32] != -1)
                        {
                          penguinoids[player][i].ym = 0;
                          penguinoids[player][i].mode = PENG_MODE_WALKING;
                          penguinoids[player][i].being_homed = 0;
              ...
              /* Otherwise, state depends on if we're on the last level */
              if (level[player] != 20)
                {
              ...
              for (j = 0; j < MAX_LASERS; j++)
                {
                  if (lasers[j].alive && penguinoids[player][i].alive)
                    {
                      if (((lasers[j].x2 == WIDTH &&
                            tmp_x >= lasers[j].x1 && tmp_x <= WIDTH) ||
                           (lasers[j].x2 == 0 &&
      ...
      if (num_penguinoids == 0 && planet_dead[player] == 0)
        {
          ...
          /* Turn all aliens (except mines & boss) into mutants: */
              ...
              if (aliens[player][i].alive)
                {
                  if (aliens[player][i].type != ALIEN_MINE)
                    {
                      if (aliens[player][i].type != ALIEN_BOSS)
          ...
          if (aliens[player][i].alive)
            {
              ...
              if (aliens[player][i].type == ALIEN_UFO)
                {
                  ...
                  if ((aliens[player][i].mode == ALIEN_MODE_HOME_PENG &&
                      ...
                      (aliens[player][i].mode == ALIEN_MODE_NORMAL &&
                       ...
                       == 0))
                    {
                      if (abs(x[player] - aliens[player][i].x) <= (WIDTH / 2))
                        {
              ...
              else if (aliens[player][i].type == ALIEN_MUTANT)
                {
                  ...
                  if (aliens[player][i].mode == ALIEN_MODE_NORMAL &&
                    ...
                    {
                      if (x[player] - aliens[player][i].x >= -(WIDTH / 2) &&
                          x[player] - aliens[player][i].x <= (WIDTH / 2))
                        {
              ...
              else if (aliens[player][i].type == ALIEN_BOSS)
                {
                  /* Move alien: */
                      ...
                      if (lasers[j].alive && aliens[player][i].alive)
                        {
                          if (((lasers[j].x2 == WIDTH &&
                              ...
                              aliens[player][i].mode != ALIEN_MODE_HURTING &&
                              (aliens[player][i].mode != ALIEN_MODE_BEAM_IN || aliens[player][i].type != ALIEN_BOSS) &&
                              aliens[player][i].mode != ALIEN_MODE_DYING)
                            {
                              /* Kill the alien: */
      ...
      if (level_beat[player] > 0)
        {
          ...
          if (level_beat[player] >= 170 - MAX_PENGUINOIDS &&
              (level_beat[player] - (170 - MAX_PENGUINOIDS)) < num_penguinoids)
            {
              ...
              add_points((((WIDTH - (num_penguinoids * 32)) / 2) +
                          ((level_beat[player] -
                            (170 - MAX_PENGUINOIDS)) * 32) + 16 +
                          x[player] - scroll[player]),
                         80 + (images[IMG_LEVEL_BONUS] -> h) + 32,
                         IMG_100);
              playsound(SND_PENG_SAVE, 1, 0);
              add_score(100);
            }

          if (level_beat[player] == 85 && num_penguinoids == 0) {
            playsound(SND_PENG_SPLAT, 1, 0);
          }
      ...
      else if (scroll[player] < WIDTH - 128 - 64 && dir[player] == DIR_LEFT)
        scroll[player] = scroll[player] + 16;
...
#define LAND_LEFT ((WIDTH / 2) - ((LAND_WIDTH / 2) * 4) - 3) // Was 177 on a 640 display
...
#define VIEW_LEFT ((WIDTH / 2) - ((WIDTH / 2) / 8))  // Was 280 on a 640 display

      dest.x = ((xm[player] * 8 + scroll[player]) / 8) + VIEW_LEFT;
      dest.y = (y[player] / 8) + 6;
      dest.w = 6;
      dest.h = 4;
      ...
      for (i = 0; i < num_players; i++)
        {
          ...
          for (j = 0; j < lives[i] && j < 11; j++)
            {
              if (lives[i] < 7)
                dest.x = j * 24 + ((WIDTH - 170) * i);
              else
                dest.x = j * 12 + ((WIDTH - 170) * i);
              
              dest.y = 24;
              dest.w = 24;
              dest.h = 16;
              
              SDL_BlitSurface(images[IMG_SHIPS + i], NULL, screen, &dest);
            }
          ...
          if (player != i || (frame % 10) < 5)
            draw_number((WIDTH - 170) * i, 40, score[i]);
          
          
          /* ((level)): */
          draw_number((WIDTH - 170) * i, 0, level[i]);
        }
      ...
      /* FIXME: They don't look good, so disabling for now -bjk 2023.06.25 */
      /*
      ...
      */
                  ...
                  if (aliens[player][i].type == ALIEN_UFO)
                    {
                      ...
                      /* Tilt left/right depending on direction */
		      if (aliens[player][i].xm == 0)
	                {
                          img = IMG_UFO_CTR00;
			}
		      else if ((aliens[player][i].xm < 0 && aliens[player][i].ym <= 0) ||
                               (aliens[player][i].xm > 0 && aliens[player][i].ym > 0))
		        {
                          img = IMG_UFO_LFT00;
                        }
		      else
		      ...
		      if (aliens[player][i].xm < 0)
		        {
                    ...
                    {
                      if (aliens[player][i].mode == ALIEN_MODE_HURTING ||
                          (aliens[player][i].mode == ALIEN_MODE_DYING &&
                           (frame / 4) % 2 == 0)
                         )
                        {
                  ...
                  if (aliens[player][i].mode != ALIEN_MODE_BEAM_IN)
                  ...
                  else
                    {
                      ...
                      for (j = (frame % 2); j < images[img]->h; j = j + 2)
                        {
                          dest.x = (tmp_x +
              ...
              if (tmp_x > -31 && tmp_x < WIDTH)
                {
                  ...
                  SDL_BlitSurface(images[IMG_BOSS_FLAME3 -
                                        flames[i].time / 4],
                                  NULL, screen, &dest);
                }
            }
      ...
      if (mesg_timer > 0)
        {
          dest.x = (WIDTH - (images[mesg_img] -> w)) / 2;
          dest.y = 80;
      ...
      if (level_beat[player] > 0)
        {
          ...
          dest.x = (WIDTH - (images[IMG_LEVEL_BONUS] -> w)) / 2;
          dest.y = 80;
          ...
          for (i = 0; i < num_penguinoids && i < (level_beat[player] / 5); i++)
            {
              if (level_beat[player] < 170 - MAX_PENGUINOIDS ||
                ...
                {
                  dest.x = ((WIDTH - (num_penguinoids * 32)) / 2) + (i * 32);
          ...
          if (num_penguinoids == 0 &&
            ...
            {
              dest.x = (WIDTH - (images[IMG_NO_BONUS] -> w)) / 2;
              dest.y = 80 + (images[IMG_LEVEL_BONUS] -> h) + 16;
      ...
      if (lives[player] < 0)
        {
          ...
          for (i = 0; i < (images[IMG_GAME_OVER] -> h); i++)
            {
              dest.x = (((WIDTH - (images[IMG_GAME_OVER] -> w)) / 2) +
                        (my_cos[(i + frame) % 32] * 2));
              dest.y = ((HEIGHT - (images[IMG_GAME_OVER] -> h)) / 2) + i;
...
#ifdef SHOW_FPS
      draw_number(0, (HEIGHT / 2), last_time + (33 * SLOWDOWN) - SDL_GetTicks());
...
char * hat_dir_name_str[16] = {
  /* See `SDL/SDL_joystick.h` */
  "......", /* 0x00 - 0000 - SDL_HAT_CENTERED */
  "up",     /* 0x01 - 0001 - SDL_HAT_UP */
  "right",  /* 0x02 - 0010 - SDL_HAT_RIGHT */
  "up-rt",  /* 0x03 - 0011 - SDL_HAT_RIGHT | SDL_HAT_UP */
  "down",   /* 0x04 - 0100 - SDL_HAT_DOWN */
  "!?",     /* 0x05 - 0101 - SDL_HAT_DOWN | SDL_HAT_UP */
  "dn-rt",  /* 0x06 - 0110 - SDL_HAT_DOWN | SDL_HAT_RIGHT */
  "!?",     /* 0x07 - 0111 - SDL_HAT_DOWN | SDL_HAT_UP | SDL_HAT_RIGHT */
  "left",   /* 0x08 - 1000 - SDL_HAT_LEFT */
  "up-lt",  /* 0x09 - 1001 - SDL_HAT_LEFT | SDL_HAT_UP */
  "!?",     /* 0x0A - 1010 - SDL_HAT_LEFT | SDL_HAT_RIGHT */
  "!?",     /* 0x0B - 1011 - SDL_HAT_LEFT | SDL_HAT_UP | SDL_HAT_RIGHT */
  "dn-lt",  /* 0x0C - 1100 - SDL_HAT_LEFT | SDL_HAT_DOWN */
  "!?",     /* 0x0D - 1101 - SDL_HAT_LEFT | SDL_HAT_UP | SDL_HAT_DOWN */
  "!?",     /* 0x0E - 1110 - SDL_HAT_LEFT | SDL_HAT_UP | SDL_HAT_RIGHT */
  "!?",     /* 0x0F - 1111 - SDL_HAT_LEFT | SDL_HAT_UP | SDL_HAT_RIGHT | SDL_HAT_DOWN */
};
...
int option_screen(void)
{
  ...
  SDLKey key;
  Uint32 last_time;
  int done, quit, option_line, old_option_line, frame, x, y;
  char txt[48];
  ...
  for (y = 0; y < screen->h; y = y + 1) {
    for (x = (y % 2); x < screen->w; x = x + 2) {
      dest.x = x;
      dest.y = y;
      dest.w = 1;
      dest.h = 1;
  ...
  write_text(14, 20, "CONFIG_JOY_THURST =");
  write_num(38, 20, joy_thrust);

  write_text(14, 21, "CONFIG_JOY_REVERSE =");
  write_num(38, 21, joy_reverse);

  write_text(14, 22, "CONFIG_HAT_NO_X =");
  write_num(38, 22, hat_no_x);

  write_text(45, 14, "sensing");
  write_text(45, 15, "-------");
  write_text(45, 16, "button = ......");
  write_text(45, 18, "axis   = ......");
  write_text(45, 19, "value  = ......");
  write_text(45, 21, "hat    = ......");
          ...
          if (event.type == SDL_KEYDOWN)
            {
              ...
              if (key == SDLK_ESCAPE)
              ...
              else if (key == SDLK_LEFT)
                {
                  ...
                  else if (option_line == 9)
                  {
                    if (joy_thrust > -1)
                      joy_thrust--;
                  }
                  else if (option_line == 10)
                  {
                    if (joy_reverse > -1)
                      joy_reverse--;
                  }
                  else if (option_line == 11)
                  {
                    if (hat_no_x > 0)
                      hat_no_x--;
                  }
              ...
              else if (key == SDLK_RIGHT)
                {
                  ...
                  {
                    if (joy_fire < MAX_JOY_BTNS)
                      joy_fire++;
                  }
                  else if (option_line == 6)
                  {
                    if (joy_bomb < MAX_JOY_BTNS)
                      joy_bomb++;
                  }
                  else if (option_line == 7)
                  {
                    if (joy_x < MAX_JOY_AXES)
                      joy_x++;
                  }
                  else if (option_line == 8)
                  {
                    if (joy_y < MAX_JOY_AXES)
                      joy_y++;
                  }
                  else if (option_line == 9)
                  {
                    if (joy_thrust < MAX_JOY_BTNS)
                      joy_thrust++;
                  }
                  else if (option_line == 10)
                  {
                    if (joy_reverse < MAX_JOY_BTNS)
                      joy_reverse++;
                  }
                  else if (option_line == 11)
                  {
...
#ifndef NOSOUND
              if (keysnd && use_sound == 1)
                playsound(SND_KEYCLICK, -1, 0);
#endif
            }
          else if (event.type == SDL_JOYBUTTONDOWN)
            {
              snprintf(txt, sizeof(txt), "button = %6d", event.jbutton.button);
              write_text(45, 16, txt);
            }
          else if (event.type == SDL_JOYBUTTONUP)
            {
              write_text(45, 16, "button = ......");
          ...
          else if (event.type == SDL_JOYAXISMOTION)
            {
              if (event.jaxis.value != 0)
                {
                  snprintf(txt, sizeof(txt), "axis   = %6d", event.jaxis.axis);
                  write_text(45, 18, txt);
                  snprintf(txt, sizeof(txt), "value  = %6d", event.jaxis.value);
                  write_text(45, 19, txt);
                }
              else
                {
                  write_text(45, 18, "axis   = ......");
            ...
            {
	      write_text(45, 21, "hat    =       ");
              snprintf(txt, sizeof(txt), "hat    = %6s", hat_dir_name_str[event.jhat.value]);
	      write_text(45, 21, txt);
            }
          else if (event.type == SDL_QUIT)
            {
              quit = 1;
...
{
  SDL_Rect dest, src;
  int done, i, j, option, old_option, count, impatience_count, ang,
  ...
  for (i = 0; i < MAX_STARFIELDS; i++)
    {
      starfields[i].radius = (rand() % (WIDTH / 2)) + 1;
  ...
  do
    {
      ...
      while (SDL_PollEvent(&event))
        {
          if (event.type == SDL_KEYDOWN)
            ...
            {
              if (event.jaxis.value < -AXIS_THRESH && old_axis >= -(AXIS_THRESH / 2))
                {
                  if (option > 0)
                    option--;
                }
              else if (event.jaxis.value > AXIS_THRESH && old_axis <= (AXIS_THRESH / 2))
                {
                  if (option < NUM_TITLE_OPTIONS - 1)
                    option++;
                }
      ...
      for (i = 0; i < MAX_STARFIELDS; i++)
        {
          ...
          if (starfields[i].radius >= WIDTH || starfields[i].time <= 0)
            {
              starfields[i].radius = (rand() % (WIDTH / 2)) + 1;
              starfields[i].angle = (rand() % 360);
      ...
      for (i = 0; i < num_starfields; i++)
        {
          for (j = 0; j < 30; j++) {
            ang = angle + starfields[i].angle - ((angle_m * j) / 60);
            dest.x = (cos(M_PI * ang / 180) * (starfields[i].radius - j)) + (WIDTH / 2);
            dest.y = (-sin(M_PI * ang / 180) * (starfields[i].radius - j)) + (HEIGHT / 2);
            dest.w = 1;
            dest.h = 1;
            
            src.x = 0;
            src.y = starfields[i].time + j;
            src.w = 1;
            src.h = 1;
      ...
      if (distortion < 2)
        {
          dest.x = (WIDTH - (images[IMG_TITLE_TITLE] -> w)) / 2;
          dest.y = 0;
	  ...
	  offset = ((dest.x + dest.w) / 8) - 10;

          draw_number((WIDTH + (images[IMG_TITLE_TITLE] -> w)) / 2 - ((images[IMG_NUMBERS] -> w) / 10) * 6,
                      images[IMG_TITLE_TITLE] -> h - images[IMG_NUMBERS]->h,
                      COPYRIGHT);
        }
      else
        {
      ...
      offset = ((WIDTH / 2) / 8) - 5;
      write_text(offset, 45, "HIGH SCORE");
      write_num(offset, 46, highscore);

      if (score[1] != -1)
        {
          offset = (WIDTH / 8) - 8;
          write_text(offset, 45, "PLAYER 2");
          write_num(offset, 46, level[1]);
          write_num(offset, 47, score[1]);
        }
...
void setup(void)
{
  ...
  if (use_fullscreen == 1)
    {
      screen = set_vid_mode(SDL_FULLSCREEN, VIDEO_BPP);
      if (screen == NULL)
        {
          fprintf(stderr,
  ...
  if (use_fullscreen == 0)
    {
      screen = set_vid_mode(0, VIDEO_BPP);
  ...
  getpixel = getpixels[screen->format->BytesPerPixel];
          ...
          if (SDL_GetTicks() > old_ticks + 50)
            {
              ...
              dest.x = (WIDTH - (images[1] -> w)) / 2;
              dest.y = HEIGHT - (images[1] -> h);
              dest.w = images[1] -> w;
              dest.h = images[1] -> h;
  ...
  if (use_sound == 1)
    {
      ...
      config_music = Mix_LoadMUS(getBundlePathSubdirAndFile("Contents/Resources/Data", MUS_CONFIG));
  ...
  do
    {
      ...
      dest.x = 0;
      dest.y = HEIGHT - (images[IMG_PRESS_A_KEY] -> h);
      dest.w = WIDTH;
      ...
      for (i = (flash % 2); i < images[IMG_PRESS_A_KEY] -> h; i = i + 2)
        {
          dest.x = (((WIDTH - (images[IMG_PRESS_A_KEY] -> w)) / 2) +
                    my_cos[(i + flash) % 32] * distortion);
          dest.y = HEIGHT - (images[IMG_PRESS_A_KEY] -> h) + i;
      ...
      SDL_UpdateRect(screen, 0, dest.y, WIDTH, dest.h);
...
SDL_Surface * set_vid_mode(unsigned flags, int bpp)
{
  ...
  depth = SDL_VideoModeOK(WIDTH, HEIGHT, VIDEO_BPP, flags);
...
void move_auroras(void)
{
  ...
  for (i = 1; i < WIDTH - 8; i += 10)
    {
      l = auroras[i - 1];
      r = auroras[i + 10];
      auroras[i + 0] = ((l * 90) + (r * 10)) / 100;
      auroras[i + 1] = ((l * 80) + (r * 20)) / 100;
      auroras[i + 2] = ((l * 70) + (r * 30)) / 100;
      auroras[i + 3] = ((l * 60) + (r * 40)) / 100;
      auroras[i + 4] = ((l * 50) + (r * 50)) / 100;
      auroras[i + 5] = ((l * 40) + (r * 60)) / 100;
      auroras[i + 6] = ((l * 30) + (r * 70)) / 100;
      auroras[i + 7] = ((l * 20) + (r * 80)) / 100;
      auroras[i + 8] = ((l * 10) + (r * 90)) / 100;
    }
}
  ...
  for (ax = 0; ax < WIDTH; ax++)
    {
      ...
      for (y = 80; y < auroras[ax]; y++)
        {
          lum = 80 + (auroras[ax] - y);

          SDL_GetRGB(getpixel(screen, dx, y), screen->format, &r, &g, &b);

          scl = (auroras[ax] * 255) / lum;

          if (player == 0)
            {
              r = ((r * (50 * lum)) + scl) / (60 * lum);
              g = ((g * 10) + scl) / 11;
              b = (((320 - lum) * 255) / 320) - b;
            }
          else
            {
              r = (((320 - lum) * 255) / 320) - r;
              g = ((g * 10) + scl) / 11;
              b = ((b * (50 * lum)) + scl) / (60 * lum);
            }

          putpixel(screen, dx, y, SDL_MapRGB(screen->format, r, g, b));
        }
    }
}
...
void kill_player(void)
{
  ...
  if (level[player] != 20)
    ...
    playsound(SND_BOSS_SUCCESS1 + (rand() % 3), 1, 1);
  ...
  do
    {
      ...
      if (mode == 0)
        ...
        {
          for (r = 0; r < (HEIGHT / 2); r = r + 5)
            {
              for (a = 0; a < 360; a = a + 2)
                {
                  src.x = (WIDTH / 2) + cos(M_PI * a / 180) * r;
                  src.y = (HEIGHT / 2) - sin(M_PI * a / 180) * r;
                  src.w = 8;
                  src.h = 8;
                  
                  dest.x = (WIDTH / 2) + cos(M_PI * (a + (frame * 5)) / 180) * r;
                  dest.y = (HEIGHT / 2) - sin(M_PI * (a + (frame * 5)) / 180) * r;
                  dest.w = 8;
                  dest.h = 8;
              ...
              for (a = 0; a < 360; a = a + 5)
                {
                  ...
                  dest.x = (WIDTH / 2) + cos(M_PI * (a + ((frame % 3600) * r / 100)) /
                                     180) * r;
                  dest.y = (HEIGHT / 2) - sin(M_PI * (a + ((frame % 3600) * r / 100)) /
                                     180) * r;
                  dest.w = 10;
                  dest.h = 10;
...
char * get_option_file_path()
{
  ...
  if (getenv("HOME") != NULL)
    ...
    {
      snprintf(fname, sizeof(fname), "defendguinrc");
      fprintf(stderr,
        "$HOME not set; saving config file to '%s' in the current directory\n",
        fname
      );
    }
  ...
  if (
    ...
    fprintf(stderr,
      "Can't find user settings directory; falling back to '%s'\n",
      fname
    );
  }
#else 
...
void load_options(void)
{
  ...
  if (fi != NULL)
          ...
          if (strchr(str, '=') != NULL)
            {
              ...
              else if (strstr(str, "CONFIG_JOY_THRUST") != NULL)
                sscanf(strchr(str, '=') + 1, "%d", &joy_thrust);
              else if (strstr(str, "CONFIG_JOY_REVERSE") != NULL)
                sscanf(strchr(str, '=') + 1, "%d", &joy_reverse);
              else if (strstr(str, "CONFIG_HAT_NO_X") != NULL)
                sscanf(strchr(str, '=') + 1, "%d", &hat_no_x);
    ...
    {
      fprintf(stderr, "Cannot read config & score file '%s'; using defaults!\n", fname);
    }
  ...
  if (fi != NULL)
    {
      ...
      fprintf(fi, "CONFIG_JOY_THRUST = %d\n", joy_thrust);
      fprintf(fi, "CONFIG_JOY_REVERSE = %d\n", joy_reverse);
      fprintf(fi, "CONFIG_HAT_NO_X = %d\n", hat_no_x);
    ...
    {
      fprintf(stderr, "Could not write to config & score file '%s'!\n", fname);
    }
